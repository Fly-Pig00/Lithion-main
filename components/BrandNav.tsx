    ...
    useEffect(() => {
        if(brands.length === 0){
          const getBrands = async () => {
            ...
            setBrands(allBrands.filter((brand: Brands) => brand.name !== 'Lithion'))
          }
            getBrands()
        }
      }, [brands])
        ...
        <div className="absolute md:relative inset-5 md:inset-auto">
            ...
            </button>
            {
                ...
                <div className={`md:absolute fixed left-0 md:left-auto top-0 md:top-auto z-10 md:w-auto w-screen h-screen md:h-auto px-10 md:pb-10 bg-secondary md:bg-primary flex flex-col items-center justify-center space-y-16 md:space-y-10`}>
                  ...
                  >
                    <svg className='fill-white' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width={16}><path d="M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"/></svg>
                  </button>
                    {   brands.length > 0 &&
                        brands?.map((brand:Brands) => {
                            ...
                            return(
                              <Link
                                  ...
                                  className={`${
                                      brand.name === 'Aved' ||
                                      brand.name === 'Charger Industries' ?
                                      "w-36" : 'w-40'

                                  } relative md:opacity-50 hover:opacity-100`}
                              >
                                  <Image
